...
for(var i = 0; i < app.matches.length; i++){
        ...
        showNoMatchesMessage() {
            ...
            for (var i = 0; i < this.matches.length; i++) { // loops all matches
                if ((this.teamInfo.name == this.matches[i].home_team_name) || (this.teamInfo.name == this.matches[i].away_team_name)) { // if both conditions are true 
                    upComingMatches = true; // variable is true
                }
            }
            if (upComingMatches == true) { // use variable to compare other conditions
...
console.log(messages);
                for (var key in messages) {
                    ...
                    name.innerHTML = messages[key].name;
